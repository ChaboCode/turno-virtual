...
import { idlFactory } from './ii_motoko_frontend.did.js';
export { idlFactory } from './ii_motoko_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_II_MOTOKO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ii_motoko_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ii_motoko_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ii_motoko_frontend.did.js")._SERVICE>}
 */
export const ii_motoko_frontend = createActor(canisterId);
